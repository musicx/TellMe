...
- Karpathy LLM-wiki 对齐设计已进入第一版实现：query/output 可回流，vault 会生成 Obsidian IDE index，`lint --health-handoff` 可生成 LLM health/reflection 任务。
